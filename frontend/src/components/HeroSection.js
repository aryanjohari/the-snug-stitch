    ...
    <div>
      ...
      <section className="grid lg:grid-cols-4 grid-cols-2 gap-1 lg:gap-4 mx-7 mt-14">
        <div className="group relative block bg-black">
          <img
            alt="Hoodie"
            src={require("../assets/hoodie men plain.jpg")}
        ...
        <div className="group relative block bg-black">
          <img
            alt="Varsity"
            src={require("../assets/MEN VARSITY.jpg")}
            className="absolute inset-0 h-full w-full object-cover opacity-75 transition-opacity group-hover:opacity-50"
          />
          <div className="relative p-4 sm:p-6 lg:p-8">
        ...
        <div className="group relative block bg-black">
          <img
            alt="Sweatshirt"
            src={require("../assets/men oversize sweatshirt.jpg")}
            className="absolute inset-0 h-full w-full object-cover opacity-75 transition-opacity group-hover:opacity-50"
          />
          <div className="relative p-4 sm:p-6 lg:p-8">
        ...
        <div className="group relative block bg-black">
          <img
            alt="Tshirt"
            src={require("../assets/oversize tshirt.jpg")}
            className="absolute inset-0 h-full w-full object-cover opacity-75 transition-opacity group-hover:opacity-50"
          />
          <div className="relative p-4 sm:p-6 lg:p-8">
