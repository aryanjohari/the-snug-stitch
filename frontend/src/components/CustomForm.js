...
const CustomForm = ({ status, message, onValidated }) => {
  ...
  return (
    <form onSubmit={(e) => handleSubmit(e)} className="justify-center items-center flex-1 flex-col md:w-full">
      ...
      <div className="text-center">
      <button type="submit" className="hover:bg-white hover:border-2 hover:border-black hover:text-black w-20 h-10 rounded-lg text-white bg-black cursor-pointer uppercase text-center border-2 border-white">
        submit
      </button>
      </div>
    </form>
